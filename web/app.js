...
const RULE_LABELS = {
  ...
  DOCKER_SECRETS_IN_ENV:                "Secret passed as ENV variable",
  DOCKER_NO_HEALTHCHECK:                "No HEALTHCHECK instruction defined",
  DOCKER_SHELL_FORM_ENTRYPOINT:         "ENTRYPOINT uses shell form instead of exec form",
  DOCKER_APT_GET_UPGRADE:               "apt-get upgrade used in Dockerfile",
  CFN_S3_PUBLIC_ACCESS:                 "S3 bucket public access not blocked",
  CFN_SG_OPEN:                          "Security group open to 0.0.0.0/0",
  CFN_RDS_PUBLIC:                       "RDS instance publicly accessible",
  CFN_IAM_WILDCARD:                     "IAM policy uses wildcard resource",
